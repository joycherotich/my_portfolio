    ...
    <div name='home' className='w-full pt-32'>
        <section className='w-full h-full max-w-[1000px] mx-auto flex flex-col justify-center px-6'>
            <div>
                ...
                <h1 className='text-4xl md:text-8xl font-bold text-[var(--secondary2)]'>JOY KIRUI</h1>
             </div>
             ...
             <div className='mt-8 dark:text-[var(--primary1)] hover:text-[var(--secondary2)] dark:hover:text-[var(--primary2)]'>
                    <a className='flex items-center' href="https://github.com/joycherotich" target="_blank" rel="noreferrer" >Jump straight to my Github <span> <BsGithub className='ml-6'/></span></a>             
             </div>

  ...
  return (
    ...
    <div className={`w-full h-32 z-10 fixed ${scroll? 'shadow-md bg-[#f8f9fa] dark:bg-black' : ''}`}>
        <div className='w-full h-full max-w-[1000px] mx-auto flex justify-between px-4 items-center '>
            <h1 className='text-4xl font-bold text-[var(--primary2)] cursor-pointer  hover:text-[var(--secondary2)]'><Link to="home" smooth={true} duration="700">Kirui</Link></h1>
        ...
        {/* Social media icons */}
                    <a href="https://www.linkedin.com/in/joy-letim-540979258/" target="_blank"><BsLinkedin className='icon-mob'/></a>
